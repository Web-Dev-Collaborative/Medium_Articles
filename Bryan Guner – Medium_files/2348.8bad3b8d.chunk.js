(self.webpackChunklite = self.webpackChunklite || []).push([
  [2348],
  {
    638: (e, t, n) => {
      ...
      var d = () => {
        ...
        return (0, i.cD)().isBot || e
          ...
          : o.createElement(
              l.bZ,
              { name: "dont_track_user", placeholder: f },
              e => {
                return e
                  ? null
                  : o.createElement(
                      ...
                      o.createElement(i.Q_, null, e => {
                        return o.createElement(h, { viewer: e });
                      })
                    );
              }
            );
      ...
      function E(e, t) {
        if (!e) return "";
        if (!t) return e;
        const n = new URL(e), r = (0, u.P7)(t), o = r.name, c = r.dimension;
        if ((o && n.searchParams.set("utm_medium", o), c)) {
          const l = c.split("."), i = a()(l, 3), s = i[0], m = i[1], p = i[2];
    ...
    94132: (e, t, n) => {
      "use strict";
      n.d(t, { T: () => y });
      const r = n(59713), a = n.n(r), o = n(67294), c = n(12291), l = n(60046), i = n(82418), u = n(97145), s = n(7530), m = n(64504), p = n(28309), f = n(67122), d = n(27952);
      function h(e, t) {
      ...
      const E = e => {
          const t = e.authDomain, n = e.productName;
          return o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(
                s.rU,
                { href: (0, d.GM)(t, n) },
                o.createElement(m.X6, { scale: "S" }, "Share your thinking.")
              )
            ),
            o.createElement(
              m.F,
              ...
              o.createElement(
                s.rU,
                { href: (0, d.GM)(t, n), inline: !0, linkStyle: "OBVIOUS" },
                "Write on ",
                n
              )
            )
              ...
              t
                ...
                : o.createElement(
                    ...
                    o.createElement(
                      ...
                      o.createElement(E, { authDomain: r, productName: a })
                    )
                  ),
              o.createElement(
                s.xu,
                ...
                o.createElement(
                  ...
                  o.createElement(
                    ...
                    o.createElement(l.Rv, { fill: f.ix })
                  ),
                  o.createElement(
                    s.xu,
                    {
                    ...
                    o.createElement(
                      ...
                      o.createElement(
                        s.rU,
                        { href: (0, d.jQ)({ authDomain: r }), inline: !0 },
                        "About"
                      )
                    ),
                    o.createElement(
                ...
                o.createElement(
                  ...
                  o.createElement(
                    ...
                    o.createElement(
                      s.xu,
                      { marginRight: "16px" },
                      o.createElement(u.E, { entryPoint: "postPageFooter" })
                    ),
                    o.createElement(
                      s.xu,
                      null,
                      o.createElement(i.H, { entryPoint: "postPageFooter" })
                    )
                  )
                )
              )
    ...
    55503: (e, t, n) => {
      "use strict";
      n.d(t, { r: () => y, C: () => v });
      const r = n(59713), a = n.n(r), o = n(28655), c = n.n(o), l = n(8575), i = n(71439), u = n(67294), s = n(12291), m = n(42963), p = n(8403), f = n(96879), d = n(27952);
      function h(e, t) {
        const n = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
          let r = Object.getOwnPropertySymbols(e);
      ...
      var y = (0, i.Ps)(E()),
        v = e => {
          ...
          const o = (0, s.v9)(e => {
            const t = e.config, n = t.authDomain, r = t.nodeEnv, a = e.navigation;
            return {
              authDomain: n,
          ...
          return (
            ...
            F ? u.createElement(m.Z, { to: (0, f.Rk)(F, P), replace: !0 }) : a
          );
        };
    },
    40605: (e, t, n) => {
      "use strict";
      n.d(t, { Z: () => v, g: () => w });
      const r = n(28655), a = n.n(r), o = n(34575), c = n.n(o), l = n(93913), i = n.n(l), u = n(2205), s = n.n(u), m = n(78585), p = n.n(m), f = n(29754), d = n.n(f), h = n(71439), g = n(67294), E = n(7530);
      function y() {
        const e = a()([
        ...
        return i()(a, [
          {
            key: "render",
            value() {
              const e = this.props.user.navItems, t = [];
              return e &&
                (e.forEach(e => {
                  const n = e.title, r = e.href;
                  n && r && t.push({ title: n, href: r });
                }),
                t.length)
                ? g.createElement(E.LU, { items: t })
                : null;
            },
          },
        ]),
    ...
    88479: (e, t, n) => {
      "use strict";
      n.d(t, { Z: () => h, k: () => g });
      const r = n(28655), a = n.n(r), o = n(71439), c = n(67294), l = n(70405), i = n(12291), u = n(40605), s = n(45076), m = n(90038), p = n(27390), f = n(27952);
      function d() {
        const e = a()([
      ...
      function h(e) {
        ...
        return c.createElement(
          ...
          c.createElement("meta", { property: "og:title", content: n }),
          c.createElement("meta", { name: "description", content: r }),
          c.createElement("meta", { property: "og:description", content: r }),
          c.createElement("meta", { name: "twitter:description", content: r }),
          E && 0 === E.length
            ...
            : null,
          S ? c.createElement("link", { rel: "canonical", href: S }) : null,
          S
            ? c.createElement("meta", { property: "og:url", content: S })
            : null,
          S
            ? c.createElement("meta", { property: "al:web:url", content: S })
            : null,
          R
            ? c.createElement("meta", { property: "al:ios:url", content: R })
            : null,
          R
            ? c.createElement("meta", {
          ...
          U
            ...
            : null,
          S
            ? c.createElement("link", { rel: "alternate", href: (0, f.zi)(j) })
            : null,
          a
            ...
            : null,
          L
            ? c.createElement("meta", { property: "og:image", content: L })
            : null,
          L
            ? c.createElement("meta", { name: "twitter:image:src", content: L })
            : null,
          g
            ? c.createElement("link", {
                rel: "me",
          ...
          A
            ...
            : null,
          c.createElement("meta", { property: "og:type", content: "profile" }),
